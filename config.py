import os
class Config(object):
    BOT_TOKEN = os.environ.get('BOT_TOKEN', '1569993609:AAEmlzAmcr0PnhsUAg8DIaIvE4hh0kU88N4')
    GUSERNAME = os.environ.get('GUSER_NAME', 'pranaypawar2019.it@mmcoe.edu.in')
    GPASSWORD = os.environ.get('GPASSWORD', 'Lucifer@2134819032')
    SCHEDULE = os.environ.get('SCHEDULE', False)
    USERID = os.environ.get('USERID', 1327168141')
